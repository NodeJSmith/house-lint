...
def test_no_divergence_ever_skips_a_file_git_would_lint(
    ...
    user can see and silence. Every known divergence errs the second way; this is what keeps it
    that way, and it is the property the surveyed alternatives (`igittigitt`, `dulwich.ignore`)
    fail.
    """
